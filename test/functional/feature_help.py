...
"""Verify that starting longcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start longcoin with -h for help text")
        ...
        self.log.info("Start longcoin with -version for version information")
        ...
        self.log.info("Start longcoind with -fakearg to make sure it does not start")
