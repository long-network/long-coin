...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Longcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Longcoin Core"
...
#define PACKAGE_NAME "Longcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Longcoin Core 0.21.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "longcoin"
