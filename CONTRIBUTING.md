Contributing to Longcoin Core
============================

The Longcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Longcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/longcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to longcoin-qt
...
The following applies to code changes to the Longcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Longcoin
Network Protocol consensus changes.

Whether a pull request is merged into Longcoin Core rests with the project merge
...
Patches that change Longcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Longcoin consensus, it must have been
...
The project leader is the release manager for each Longcoin Core release.
