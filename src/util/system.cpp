...
const char * const BITCOIN_CONF_FILENAME = "longcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Longcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Longcoin";
#else
    // Unix-like
    return pathRet / ".longcoin";
#endif
#endif
}
