...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " longcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  longcoin-tx [options] <hex-tx> [commands]  Update hex-encoded longcoin transaction\n" +
            "or:     longcoin-tx [options] -create [commands]   Create hex-encoded longcoin transaction\n" +
            "\n";
