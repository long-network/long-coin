...
bech32_templates = [
  ...
  ('lngc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('lngc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('lngc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('lngc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tlngc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlngc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlngc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlngc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tlngc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlngc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlngc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlngc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rlngc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rlngc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rlngc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rlngc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tlngc',   17, 32, Encoding.BECH32M, False, False, False),
  ('rlngc',  3,  1, Encoding.BECH32M, False, False, False),
  ('lngc',   15, 41, Encoding.BECH32M, False, False, False),
  ('tlngc',    0, 16, Encoding.BECH32,  False, False, False),
  ('rlngc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('lngc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tlngc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rlngc',  0, 20, Encoding.BECH32,  False, False, True),
  ('lngc',    0, 20, Encoding.BECH32M, False, False, False),
  ('tlngc',    0, 32, Encoding.BECH32M, False, False, False),
  ('rlngc',  0, 20, Encoding.BECH32M, False, False, False),
  ('lngc',    1, 32, Encoding.BECH32,  False, False, False),
  ('tlngc',    2, 16, Encoding.BECH32,  False, False, False),
  ('rlngc', 16, 20, Encoding.BECH32,  False, False, False),
]
