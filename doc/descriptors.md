# Support for Output Descriptors in Longcoin Core

Since Longcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `lngc1...` for mainnet or `tlngc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Longcoin Core wallets, a convenience function `combo` is
